      ...
      <div className="h-full flex justify-center items-center p-4">
        <div className="container grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="text-white space-y-4 lg:pr-36">
            ...
            <p className="text-orange-400" data-aos="fade-down" data-aos-delay="300">
            ...
            <button
              data-aos="fade-up"
              data-aos-delay="400"
              className="bg-orange-200 text-black font-semibold hover:bg-blue-700 px-6 py-2 rounded-md cursor-pointer transition-colors duration-300"
            >
              LEARN MORE
            </button>
